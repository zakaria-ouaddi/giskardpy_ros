...
def main():
    ...
    pose_pre_pick = create_pose(0.8, -0.4, 1.1, roll=3.14) 
    # Pick: At object
    pose_pick     = create_pose(0.8, -0.4, 0.9, roll=3.14) 
    
    # Place Sequence
    pose_lift      = create_pose(0.8, -0.4, 1.2, roll=3.14)
    pose_pre_place = create_pose(0.9, 0.2, 1.4, roll=3.14)
    pose_place     = create_pose(0.9, 0.2, 1.2, roll=3.14)
    pose_retreat   = create_pose(0.9, 0.2, 1.4, roll=3.14)
